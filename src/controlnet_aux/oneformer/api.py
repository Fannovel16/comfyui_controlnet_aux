...
from controlnet_aux.oneformer.detectron2.config import get_cfg
from controlnet_aux.oneformer.detectron2.projects.deeplab import add_deeplab_config
from controlnet_aux.oneformer.detectron2.data import MetadataCatalog

from controlnet_aux.oneformer.oneformer import (
...
from controlnet_aux.oneformer.oneformer.demo.defaults import DefaultPredictor
from controlnet_aux.oneformer.oneformer.demo.visualizer import Visualizer, ColorMode
