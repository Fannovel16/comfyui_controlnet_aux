...
if os.getenv('AUX_ORT_PROVIDERS'):
    ...
    ONNX_PROVIDERS = ["CUDAExecutionProvider", "DirectMLExecutionProvider", "OpenVINOExecutionProvider", "ROCMExecutionProvider", "CPUExecutionProvider", "MIGraphXExecutionProvider"]
