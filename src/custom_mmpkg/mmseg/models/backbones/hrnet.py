...
from custom_mmpkg.mmcv.cnn import (build_conv_layer, build_norm_layer, constant_init,
                      kaiming_init)
from custom_mmpkg.mmcv.runner import load_checkpoint
from custom_mmpkg.mmcv.utils.parrots_wrapper import _BatchNorm

from custom_mmpkg.mmseg.ops import Upsample, resize
...
class HRNet(nn.Module):
    ...
    Example:
        >>> from custom_mmpkg.mmseg.models import HRNet
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
