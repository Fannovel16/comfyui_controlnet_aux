...
import os
import torch
from controlnet_aux.oneformer.pycocotools.cocoeval import COCOeval, maskUtils

from controlnet_aux.oneformer.detectron2.structures import BoxMode, RotatedBoxes, pairwise_iou_rotated
