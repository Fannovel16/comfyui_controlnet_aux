...
from controlnet_aux.oneformer.detectron2.layers import ShapeSpec, move_device_like
from controlnet_aux.oneformer.detectron2.structures import Boxes, RotatedBoxes
